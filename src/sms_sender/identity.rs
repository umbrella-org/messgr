...
use super::AppState;
use super::model::SmsSenderError;
...
/// AGENTS.md hard invariant 10). The bank's own auth service is registered
/// as an ordinary producer (decision 2); no new identity mechanism.
...
impl FromRequestParts<AppState> for ProducerContext {
    ...
    async fn from_request_parts(
        ...
        let subject = parts
            .extensions
            .get::<PeerCertSubject>()
            .ok_or(SmsSenderError::MissingPeerCertificate)?
            .0
            .clone();

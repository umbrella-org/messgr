...
|---|---|---|---|---|---|---|
| T-049 | Admin panel: quota dashboard, kill-switch console, scheduled queue, producer registry | high | high | L | [T-048] |  |
...
| T-037 | Consent gate at dispatch | yes — MERGED: PR #56 merged to `main` (`47e5b99`) |
